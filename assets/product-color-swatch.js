...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Function to handle quick view for a single modal
  function handleQuickView(quickViewModal) {
    // Find the inputs in the current modal
    var inputs = quickViewModal.querySelectorAll('input[name="Colour"]');
  ...
  // Function to handle quick view for all modals
  function handleAllQuickViews() {
    // Find all quick view modals with the class 'quick-add__modal'
    var quickViewModals = document.querySelectorAll('.quick-add__modal');

    // Loop through all the modals and attach event listeners
    quickViewModals.forEach(function(quickViewModal) {
      // Trigger the custom 'modalOpened' event (assuming you trigger it somehow)
      quickViewModal.dispatchEvent(new Event('modalOpened'));

      // Call the handleQuickView function to set up event listeners for this modal
      handleQuickView(quickViewModal);
    });
  }

  // Call the function to handle all quick views
  handleAllQuickViews();
});
